...
func TestSessionRepository(t *testing.T) {
	...
	testFn := func(t *testing.T, repo interfaces.Repository) {
		...
		sess := session.NewSession(ctx, ticketID, types.UserID("user-test"), "test query", "") //nolint:staticcheck // legacy Session fields tested here
		...
		t.Run("GetSessionsByTicket", func(t *testing.T) {
			...
			sess2 := session.NewSession(ctx, ticketID2, "", "", "") //nolint:staticcheck // legacy Session fields tested here
		...
		t.Run("GetSessionsByTicket with multiple sessions", func(t *testing.T) {
			...
			sess3a := session.NewSession(ctx, ticketID3, "", "", "") //nolint:staticcheck // legacy Session fields tested here
			sess3b := session.NewSession(ctx, ticketID3, "", "", "") //nolint:staticcheck // legacy Session fields tested here
		...
		t.Run("UpdateStatus to aborted", func(t *testing.T) {
			...
			sess4 := session.NewSession(ctx, ticketID4, "", "", "") //nolint:staticcheck // legacy Session fields tested here
		...
		t.Run("DeleteSession", func(t *testing.T) {
			...
			sess5 := session.NewSession(ctx, ticketID5, "", "", "") //nolint:staticcheck // legacy Session fields tested here
