...
- `title`: Provide a one-line title that summarizes the entire alert. Use the field values from the original alert data as much as possible; however, if these expressions are inadequate, update the original text or generate a new one.
