...
func CreateList(ctx context.Context, repo interfaces.Repository, inquiry interfaces.LLMClient, thread slack.Thread, user *slack.User, alerts alert.Alerts) (*alert.List, error) {
	...
	resp, err := llm.Ask[prompt.MetaListPromptResult](ctx, inquiry, p)
	if err != nil {
