...
func (x *Service) buildInitTools(ctx context.Context) []*genai.FunctionDeclaration {
...
func (x *Service) handleInit(ctx context.Context, resp *genai.GenerateContentResponse) (context.Context, bool, error) {
	var response string
	var contSsn bool
