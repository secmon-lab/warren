...
func (x *ActionService) Execute(ctx context.Context, name string, ssn interfaces.GenAIChatSession, args model.Arguments) (string, error) {
	...
	return action.Execute(ctx, ssn, args)
}
