...
func (x *ServiceThread) ChannelID() string {
	return x.channelID
}

func (x *ServiceThread) ThreadID() string {
	return x.threadID
}
...
func (x *Service) PostMessage(ctx context.Context, message string) (*SlackThread, error) {
	channelID, timestamp, err := x.client.PostMessageContext(ctx, x.channelID, slack.MsgOptionText(message, false))
	if err != nil {
...
func (x *Service) NewThread(thread slack.SlackThread) interfaces.SlackThreadService {
	return &SlackThread{
		slackMetadata: x.slackMetadata,
		channelID:     thread.ChannelID,
		threadID:      thread.ThreadID,
		slackClient:   x.client,
	}
}
...
func (x *ServiceThread) UpdateAlert(ctx context.Context, alert alert.Alert) error {
	blocks := buildAlertBlocks(alert)
...
func (x *ServiceThread) PostNextAction(ctx context.Context, action prompt.ActionPromptResult) error {
...
func (x *ServiceThread) AttachFile(ctx context.Context, title, fileName string, data []byte) error {
	if len(data) == 0 {
...
func (x *ServiceThread) Reply(ctx context.Context, message string) {
	blocks := []slack.Block{
...
func (x *ServiceThread) PostFinding(ctx context.Context, finding alert.AlertFinding) error {
...
func (x *ServiceThread) PostPolicyDiff(ctx context.Context, diff *model.PolicyDiff) error {
...
func (x *ServiceThread) PostAlerts(ctx context.Context, alerts []alert.Alert) error {
...
func (x *ServiceThread) PostAlertList(ctx context.Context, list *alert.List) error {
...
func (x *ServiceThread) PostAlertClusters(ctx context.Context, clusters []alert.List) error {
